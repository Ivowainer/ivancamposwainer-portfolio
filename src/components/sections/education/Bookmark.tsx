        ...
        <div className="flex flex-col">
            <div className="flex gap-3 ">
                ...
                <div className="flex flex-col gap-1 left-12 top-[.5px]">
                    <p className="font-semibold text-gray-800">{education.title}</p>
                    <p className="font-normal text-sm text-gray-400">{education.date}</p>
                    <p className="font-normal text-gray-500">{education.description}</p>
                </div>
            </div>
        </div>
    );
