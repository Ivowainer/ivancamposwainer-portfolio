const RacketIcon = () => {
    return (
        <svg version="1.1" id="circle_pieces" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 511.875 511.824" enableBackground="new 0 0 511.875 511.824">
            <circle id="circle" fill="#FFFFFF" cx="256.252" cy="255.986" r="253.093" />
            <path
                id="blue-piece"
                fill="#3E5BA9"
                d="M455.398,412.197c33.792-43.021,53.946-97.262,53.946-156.211
	...
	"
            ...
            <path
                id="left-red-piece"
                fill="#9F1D20"
                d="M220.003,164.337c-39.481-42.533-83.695-76.312-130.523-98.715
	...
	C100.111,319.392,164.697,219.907,220.003,164.337z"
            ...
            <path
                id="bottom-red-piece"
                fill="#9F1D20"
                d="M266.638,221.727c-54.792,59.051-109.392,162.422-129.152,257.794
